...
INSERT INTO `erp_customer` VALUES ('d4783d4d3b1c446c8f549e770f8a64cc', '小二', '15909090909', '科技大学', '是走势', '2018-03-13 14:42:08', '2018-03-13 14:42:08', '1');
...
CREATE TABLE `erp_production_plan` (
  ...
  `plan_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '计划时间',
...
CREATE TABLE `erp_task` (
  ...
  `outcompany_hep` varchar(2) DEFAULT NULL COMMENT '是否外协',
