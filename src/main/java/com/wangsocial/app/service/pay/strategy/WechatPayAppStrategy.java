...
import com.wangsocial.app.service.pay.util.app.wechat.util.MD5;
import com.wangsocial.app.service.pay.util.app.wechat.util.Util;
    ...
    private String genProductArgs(Map<String, Object> params) {
        try {
            ...
            if (StringUtils.isNotBlank(orderCode)) {
                packageParams.add(new BasicNameValuePair("body", "往往-订单编号：" + orderCode));
            } else {
                packageParams.add(new BasicNameValuePair("body", "往往订单支付"));
            }
