package com.wangsocial.app.service.pay.strategy;

import com.wangsocial.app.util.PropertiesUtil;
import com.wangsocial.app.web.listener.InitListener;
import com.wangsocial.app.enums.PayType;
import com.wangsocial.app.service.ICheckSellerService;
...
public class AlipayAppStrategy implements PayStrategy {
    ...
    private String makeGlobalParam(Map<String, Object> params) {
        ...
        String sign = com.wangsocial.app.service.pay.util.app.ali.global.sign.RSA.sign(sb.toString(), PropertiesUtil.getValue("pay.request.alipayAppGlobal.private_key"), PropertiesUtil.getValue("pay.request.alipayAppGlobal.input_charset"));
        try {
    ...
    private String makeMainParams(Map<String, Object> params, String retUrl) {
        ...
        String sign = com.wangsocial.app.service.pay.util.app.ali.main.sign.RSA.sign(sb.toString(), PropertiesUtil.getValue("pay.request.alipayAppMain.private_key"), PropertiesUtil.getValue("pay.request.alipayAppMain.input_charset"));
        try {
