...
public class AlipayWapStrategy implements PayStrategy {
    ...
    private String makeGlobalParam(Map<String, Object> params, String retUrl) {
        ...
        //建立请求
        String sHtmlText = com.wangsocial.app.service.pay.util.web.ali.global.util.AlipaySubmit.buildRequestParams(sParaTemp);
    ...
    private String makeMainParam(Map<String, Object> params, String retUrl) {
        ...
        //建立请求
        String sHtmlText = com.wangsocial.app.service.pay.util.web.ali.main.util.AlipaySubmit.buildRequestParams(sParaTemp);
        if(logger.isDebugEnabled()){
            logger.debug("alipay参数信息:{}", sHtmlText);
        }
        return sHtmlText;
